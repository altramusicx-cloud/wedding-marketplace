...
export function HeroSection() {
    return (
        <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 to-sage/10">
            ...
            <div className="container-custom py-6 md:py-8">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <h1 className="text-2xl md:text-4xl font-heading font-bold text-charcoal mb-3">
                        Temukan Vendor
                        <span className="block text-primary">Pernikahan Terbaik</span>
                    </h1>

                    {/* Description - lebih kecil */}
                    <p className="text-sm md:text-base text-neutral-600 mb-5 max-w-xl mx-auto leading-relaxed">
            ...
            <div className="absolute top-4 left-4 w-20 h-20 rounded-full bg-primary/10 blur-xl"></div>
