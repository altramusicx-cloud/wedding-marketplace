...
export const metadata = generateMetadata({
    ...
    description: 'Cari dan bandingkan vendor pernikahan terpercaya di Kalimantan. Foto, dekorasi, catering, venue, dan lebih banyak lagi. Hubungi langsung via WhatsApp!',
    url: '/',
})
