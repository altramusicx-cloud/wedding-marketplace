...
export default function ProductsClient({
    ...
    const handleToggleFeatured = async (productId: string, currentFeatured: boolean) => {
        try {
            const { success, error } = await toggleProductFeatured(productId, !currentFeatured)
            ...
            if (success) {
                ...
                setProducts(prev =>
                    prev.map(p =>
                        p.id === productId
                            ? { ...p, is_featured: !currentFeatured }
                            : p
                    )
                )
            } else {
                alert(error || 'Gagal mengubah status featured')
            }
        } catch (error) {
            console.error('Error:', error)
                                                        ...
                                                        <DropdownMenu>
                                                            ...
                                                            <DropdownMenuContent align="end">
                                                                ...
                                                                >
                                                                    ...
                                                                    {isDeleting === product.id ? 'Menghapus...' : 'Hapus'}
                                                                </DropdownMenuItem>
                                                            </DropdownMenuContent>
                                                        </DropdownMenu>
                                                    </div>
